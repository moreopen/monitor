	...
	<script src="/js/highstock.js"></script>
 	...
 	<script type="text/javascript"> 
 		...
 		function getThisMonthData(){
        	...
        	$.ajax({
 				type:"POST",
 				url:"/monitor/dataEvent/getDataPerDay.htm?menuCode="+$("#menuCode").val(),
        		dataType:"json",
		...
		var quxianType = "perday";//default value
    			...
    			if(thisObj.attr("index")==0){//表示勾选的是当月
	    			...
	    			if($(this).attr("checked")){
	    				...
	    				var thisObj=$(this);
		    				$.ajax({
				        		type:"POST",
				        		url:"/monitor/dataEvent/getDataPerDay.htm?menuCode="+$("#menuCode").val()+"&month="+$(this).val(),
...
<div style="font-size:12px;margin:10px">
	...
	<input type="radio"  name="quxianTypeRadio" value="perday" class="quxianTypeRadio" checked/>日统计(按月)
</div>
