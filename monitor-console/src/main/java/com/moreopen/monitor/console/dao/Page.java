...
public class Page implements Serializable {
	...
	public boolean hasNextPage() {
		return this.getCurrentPageNo() > 0 && this.getCurrentPageNo() < this.getTotalPageCount();
	}
	...
	public boolean hasPreviousPage() {
		return this.getCurrentPageNo() > 1 && this.getCurrentPageNo() <= this.getTotalPageCount();
	}
